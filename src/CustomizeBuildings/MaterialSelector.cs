...
namespace CustomizeBuildings
{
    ...
    public class MaterialSelector_ConfigureScreen_Patch
    {
        ...
        {
            return CustomizeBuildingsState.Instance.BuildingAdvancedGlobalFlag;
        }
        ...
        public static void Change(Recipe.Ingredient ingredient, Recipe recipe, List<Tag> list)
        {
            ...
            var setting = CustomizeBuildingsState.Instance.BuildingAdvancedMaterial.FirstOrDefault(f => f.Id == recipe.Name && (f.Index == null || f.Index == num));
            if (setting != null)
            {
        ...
        {
            int num = recipe.Ingredients.IndexOf(ingredient);
            var setting = CustomizeBuildingsState.Instance.BuildingAdvancedMaterial?.FirstOrDefault(f => f.AppliesTo(recipe.Result) && (f.Index == null || f.Index == num));
            if (setting == null)
                return;
