...
namespace CustomizeBuildings
{
    ...
    public class CustomizeBuildingsState
    {
        ...
        #region Reset Button
        [Option("Reset To Klei Default", "Leave Menu with the CANCEL button!")] [JsonIgnore]
        ...
        [Option("Reset To Custom Default", "Leave Menu with the CANCEL button!")] [JsonIgnore]
        ...
        #region Generator
        [Option("Solar Max Power", "Limit of how much light can be converted. Does not increase energy per lumen.", "Generator")]
        public float SolarMaxPower { get; set; } = 600f;
        [Option("Solar Energy Multiplier", "Multiplies power generation. Limited up to 'Solar Max Power'.", "Generator")]
        ...
        #region Pipes
        [Option("Pipe Throughput Percent", "Percent of pipe useage for Aquatuner and Air Conditioner.", "Pipes")]
        ...
        public bool AutoSweeperPickupAnything { get; set; } = true;
        #endregion
        ...
        public static Config.Manager<CustomizeBuildingsState> StateManager = new Config.Manager<CustomizeBuildingsState>(Config.PathHelper.CreatePath("CustomizeBuildings"), true, null, null);
