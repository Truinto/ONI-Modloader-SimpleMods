...
#pragma warning disable IDE1006 // ignore naming style
#pragma warning disable CS8321 // ignore unused method
...
namespace CustomizeBuildings
{
    ...
    public class CustomizeBuildingsState : BaseSettings<CustomizeBuildingsState>, IManualConfig
    {
        ...
        public System.Action<object> ResetToKleiDefault => delegate (object nix)
        {
            ...
            SealInsulateStorages = false;
            LockerKG = 20000f;
            LockerSmartKG = 20000f;
            StorageTileKG = 1000f;
            GasReservoirKG = 1000f;
            ...
            FishFeederKG = 200f;
            BottleFillerKG = 200f;
            CanisterFillerKG = 200f;
            BottleEmptierKG = 200f;
            CanisterEmptierKG = 200f;
            BottleEmptierConduitKG = 200f;
            CanisterEmptierConduitKG = 200f;
            ...
            RailgunMaxLaunch = 200f;
            DrillConeKG = 1000f;
            RocketPortGas = 1f;
            RocketPortLiquid = 10f;
            RocketPortSolid = 20f;
            RadBattery = 1000f;

            SweepyStationKG = 1000f;
            SweepBotKG = 500f;
            ...
            SmallPetroleumEngineKG = 450f;
            HEPEngineStorage = 4000f;
            LiquidFuelTankKG = 900f;
            SmallOxidizerTankKG = 450f;
            LargeSolidOxidizerTankKG = isVanilla ? 2700f : 900f;
            LiquidOxidizerTankKG = isVanilla ? 2700f : 450f;

            ElectrolizerMaxPressure = 1.8f;
            AirfilterDropsCanisters = false;
            AirConditionerAbsoluteOutput = false;
            AirConditionerAbsolutePowerFactor = 0f;
            AirConditionerHeatEfficiency = 1f;
            SpaceHeaterTargetTemperature = false;
            AlgaeTerrariumPatch = false;
            DoorSelfSealing = false;
            DoorPressureInsulationFactor = 1f;
            DoorPressureSpeedUnpowered = 0.65f;
            DoorPressureSpeedPowered = 5f;
            DoorBunkerSpeedUnpowered = 0.01f;
            DoorBunkerSpeedPowered = 0.1f;
            DoorManualSpeed = 1f;
            DoorInsulatedSpeed = 1f;
            NoDupeValves = false;
            NoDupeSwitches = false;
            NoDupeToogleBuildings = false;
            NoDupeToogleDoors = false;
            ScannerQualityMultiplier = 1f;
            TelescopeClearCellRadius = 5;
            TelescopeAnalyzeRadius = 3;
            LadderCometInvincibility = false;
            RocketPlatformInvincibility = false;
            SolarMaxPower = 380f;
            ...
            PipeLiquidPump = 10f;
            PipeGasPump = 0.5f;
            PipeLiquidPumpMini = 1f;
            PipeGasPumpMini = 0.05f;
            ConveyorRailPackageSize = 20f;
            ConveyorLoaderHasSlider = false;
            ConveyorReceptacleHasSlider = false;
            ConveyorLoaderAcceptLiquidsGas = false;
            ValveEnableTemperatureFilter = false;
            ConveyorMeterLimit = 500f;
            ...
            RoboMinerHeight = 9;
            RoboMinerOffset = 0;
            RoboMinerSpeedMult = 1f;
            RoboMinerRegolithTurbo = false;
            RoboMinerDigThroughGlass = false;
            RoboMinerDigAnyTile = false;
            DrillConeConsumption = 0.05f;
            DrillConeSpeed = 7.5f;
            WireSmallWatts = 1000;
            WireRefinedWatts = 2000;
            WireHeavyWatts = 20000;
            WireRefinedHeavyWatts = 50000;
            PowerTransformerLarge = 4000;
            PowerTransformerSmall = 1000;
            TransitTubeAnywhere = false;
            TransitTubeUTurns = false;
            TransitTubeJoulesPerLaunch = 10000f;
            TransitTubeJouleCapacity = 40000f;
            NoDupeGlobal = false;
            NoDupeApothecary = false;
            NoDupeClothingFabricator = false;
            NoDupeCookingStation = false;
            NoDupeGourmetCookingStation = false;
            NoDupeEggCracker = false;
            NoDupeGlassForge = false;
            NoDupeMetalRefinery = false;
            NoDupeMicrobeMusher = false;
            NoDupeRockCrusher = false;
            NoDupeDiamondPress = false;
            NoDupeSuitFabricator = false;
            NoDupeSupermaterialRefinery = false;
            NoDupeSludgePress = false;
            NoDupeCompost = false;
            NoDupeDesalinator = false;
            NoDupeOilRefinery = false;
            NoDupeOilWellCap = false;
            NoDupeIceCooledFan = false;
            NoDupeRanchStation = false;
            NoDupeTelescope = false;
            NoDupeAlgaeTerrarium = false;
            NoDupePayloadOpener = false;
            NoDupeMilkPress = false;
            NoDupeChemicalRefinery = false;
            NoDupeMissileFabricator = false;
            NoDupeDeepfryer = false;
            SkillStationEnabled = false;
            SkillStationCostTime = 180f;
            SkillStationCostReset = 0f;
            SkillStationCostRemoveTrait = 10000f;
            SkillStationCostAddTrait = 10000f;
            SkillStationCostBadTrait = -10000f;
            SkillStationCostAddAptitude = 10000f;
            SkillStationCostAddAttribute = 5000f;
            BuildingBaseSettingGlobalFlag = false;
            BuildingAdvancedGlobalFlag = false;
        ...
        #region Door
        [Option("CustomizeBuildings.LOCSTRINGS.DoorSelfSealing_Title", "CustomizeBuildings.LOCSTRINGS.DoorSelfSealing_ToolTip", "Door")]
        ...
        public float DoorPressureSpeedPowered { get; set; } = 5f;
        [Option("CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedUnpowered_Title", "CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedUnpowered_ToolTip", "Door", "F2")]
        public float DoorBunkerSpeedUnpowered { get; set; } = 0.01f;
        [Option("CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedPowered_Title", "CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedPowered_ToolTip", "Door", "F1")]
        public float DoorBunkerSpeedPowered { get; set; } = 0.1f;
        [Option("CustomizeBuildings.LOCSTRINGS.DoorManualSpeed_Title", "CustomizeBuildings.LOCSTRINGS.DoorManualSpeed_ToolTip", "Door", "F0")]
        public float DoorManualSpeed { get; set; } = 1f;
        [Option("CustomizeBuildings.LOCSTRINGS.DoorInsulatedSpeed_Title", "CustomizeBuildings.LOCSTRINGS.DoorInsulatedSpeed_ToolTip", "Door", "F0")]
        public float DoorInsulatedSpeed { get; set; } = 1f;
        #endregion
        ...
        public Dictionary<string, BuildingStruct>? BuildingBaseSettings_Old = null;
        public List<BuildingStruct> BuildingBaseSettings { get; set; } = new() {
            new(WireHighWattageConfig.ID, LocationRule: BuildLocationRule.Anywhere),
            new(WireRefinedHighWattageConfig.ID, LocationRule: BuildLocationRule.Anywhere, BaseDecor: -5f, BaseDecorRadius: 1f),
            new(TravelTubeConfig.ID, LocationRule: BuildLocationRule.Anywhere),
            new(BedConfig.ID, Rotations: PermittedRotations.FlipH),
            new(LuxuryBedConfig.ID, Rotations: PermittedRotations.FlipH),
            new(StorageLockerConfig.ID, LocationRule: BuildLocationRule.Anywhere),
            //new BuildingStruct(DoorConfig.ID, IsFoundation: true),
        };
        ...
        public List<BuildingAdv> BuildingAdvancedMaterial { get; set; } = new List<BuildingAdv>() {
            new(TravelTubeConfig.ID, null, true, "Glass Ice"),
            new(TravelTubeWallBridgeConfig.ID, null, true, "Glass Ice"),
        };
        ...
        protected override string BeforeUpdate(int oldVersion, string json)
        {
            if (oldVersion < 60)
            {
                ...
                json = json.Replace("\"BuildingBaseSettings\": {", "\"BuildingBaseSettings_Old\": {");
            }
            return json;

            void changeToList(string property) // replace Dictionary with List
            {
                // example: property = "\"BuildingBaseSettings\":"
                var sb = new StringBuilder(json);
                int tlen = json.Length;
                int i = json.IndexOf(property);
                if (i < 0)
                    return;

                i += property.Length; // goto the end of the json property name

                while (i < tlen && json[i] is ' ' or '\t' or '\r' or '\n') i++; // skip whitespaces

                if (i >= tlen || json[i] is not '{')
                {
                    Helpers.Print($"Exception: {property} did not start with {{");
                    return;
                }
                ...
                while (true)
                {
                    if (++i >= tlen) // failure
                    {
                        Helpers.Print($"Exception: {property} end of file");
                        return;
                    }
                    else if (depth == 0 && json[i] is '}') // success
                    {
                        sb[i] = ']';
                        json = sb.ToString();
                        break;
        ...
        protected override bool OnUpdate()
        {
            ...
            if (Version < 44 && DrillConeKG < 1000f)
                DrillConeKG = 1000f;
            if (Version < 52 && SpaceBattery < 100000f)
                SpaceBattery = 100000f;
            if (Version < 56)
                SkillStationEnabled = false;
            if (Version < 57)
            ...
            if (BuildingBaseSettings_Old != null) // version 60
            {
                ...
                foreach (var item in BuildingBaseSettings_Old)
                {
                    item.Value.Id = item.Key;
                    BuildingBaseSettings.Add(item.Value);
                    Helpers.PrintDebug($"DEBUG- added {item.Value.Id}");
                }
                BuildingBaseSettings_Old = null;
            }
            return true;
        }
    ...
    public class CustomStrings
    {
        public static void LoadStrings()
        {
            ...
            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorPressureInsulationFactor", "DoorPressureInsulationFactor");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorPressureInsulationFactor_Title", "Pressured Door Insulation Factor");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorPressureInsulationFactor_ToolTip", "In percent how much heat is transfered through the door. 0% perfect; 10% same as insulated door; 100% normal");

            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorPressureSpeedUnpowered", "DoorPressureSpeedUnpowered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorPressureSpeedUnpowered_Title", "Pressured Door Speed Unpowered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorPressureSpeedUnpowered_ToolTip", "Pressure door speed unpowered. Normal: 0.65");

            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorPressureSpeedPowered", "DoorPressureSpeedPowered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorPressureSpeedPowered_Title", "Pressured Door Speed Powered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorPressureSpeedPowered_ToolTip", "Pressure door speed powered. Normal: 5.0");

            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorBunkerSpeedUnpowered", "DoorBunkerSpeedUnpowered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedUnpowered_Title", "Bunker Door Speed Unpowered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedUnpowered_ToolTip", "Bunker door speed unpowered. Normal: 0.01");

            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorBunkerSpeedPowered", "DoorBunkerSpeedPowered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedPowered_Title", "Bunker Door Speed Powered");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorBunkerSpeedPowered_ToolTip", "Bunker door speed powered. Normal: 0.1");

            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorManualSpeed", "DoorManualSpeed");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorManualSpeed_Title", "Manual Door Speed");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorManualSpeed_ToolTip", "Manual door speed. Normal: 1.0");

            Helpers.StringsAddProperty("CustomizeBuildings.PROPERTY.DoorInsulatedSpeed", "DoorInsulatedSpeed");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorInsulatedSpeed_Title", "Insulated Door Speed");
            Helpers.StringsAdd("CustomizeBuildings.LOCSTRINGS.DoorInsulatedSpeed_ToolTip", "Insulated door speed. Normal: 1.0");
            #endregion
            #region Drill Cone
